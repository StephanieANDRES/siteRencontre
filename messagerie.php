...
$messages = $pdo->prepare("SELECT * FROM messages WHERE expediteur_id = ? OR destinataire_id = ?");
...
<div class="container mx-auto mt-10">
    ...
    <div class="mt-6 bg-white p-6 rounded-lg shadow-md">
        ...
        <?php foreach ($messages_list as $message): ?>
            <p><strong><?= $message['expediteur_id'] == $user_id ? "Moi" : "Autre" ?>:</strong> <?= $message['contenu'] ?></p>
        <?php endforeach; ?>
    </div>
</div>
